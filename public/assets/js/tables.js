...
$(document).ready(function () {
    window.loadTables = function () {
        // Gán vào window để có phạm vi toàn cục
        $.ajax({
            ...
            success: function (data) {
                let html = "";
                data.forEach((table) => {
                    html += `<div class="table-card ${table.status}" data-id="${table.id}">
                                    ...
                                    <div class="table-info">
                                        <span><i class="fas fa-money-bill-wave"></i> ${formatPrice(
                                            table.price
                                        )}đ/giờ</span>
                                    ...
                                    <div class="table-actions">
                                        ...
                                        <button class="action-btn delete-btn" onclick="deleteTable(${
                                            table.id
                                        })">
    ...
    //Booking 
    $(document).on("click", ".book-table-btn", function () {
        var tableId = $(this).data("table-id");
        $("#bookingTableId").val(tableId); // Gán ID bàn vào input ẩn
